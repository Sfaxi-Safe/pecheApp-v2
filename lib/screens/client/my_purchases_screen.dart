...
class _MyPurchasesScreenState extends State<MyPurchasesScreen> {
  ...
  Widget _buildPurchaseCard(BuildContext context, Map<String, dynamic> purchase) {
    ...
    final finalPrice = purchase['prixfinale'] ?? purchase['current'] ?? purchase['prixinitial'] ?? 'N/A';
    final date = purchase['datesoumettre'] != null
        ? DateFormat('dd/MM/yyyy').format(DateTime.parse(purchase['datesoumettre']))
        : 'Date inconnue';
  ...
  void _showPurchaseDetails(BuildContext context, Map<String, dynamic> purchase) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              if (purchase['photo'] != null && File(purchase['photo']).existsSync()) ...[
                ClipRRect(
              ...
              _buildDetailItem('Identifiant', purchase['identifiant'] ?? 'N/A'),
              ...
              _buildDetailItem('Prix payé', '${purchase['prixfinale'] ?? purchase['current'] ?? purchase['prixinitial'] ?? 'N/A'} €'),
              _buildDetailItem('Prix initial', '${purchase['prixinitial'] ?? 'N/A'} €'),
